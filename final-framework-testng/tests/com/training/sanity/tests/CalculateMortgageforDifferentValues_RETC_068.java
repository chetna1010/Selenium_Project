...
public class CalculateMortgageforDifferentValues_RETC_068 {
	...
	@Test(dataProvider = "excel-inputs1" ,dataProviderClass=CalculateMortgageDataProvider.class)

	//To test whether application allows the user to calculate Mortgage in for different values Prestige under Commercial tab
	public void calculateMortgageforDifferentValuesClass(String salesPrice, String downPayment, String longTerm, String interestRate) throws AWTException, InterruptedException {
